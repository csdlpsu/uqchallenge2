...
\title{A Bayesian latent Gaussian process framework for aerodynamic uncertainty quantification}
...
\begin{itemize}
    ...
    \item We demonstrate the predictive UQ capabilities of our method by compariing against the true uncertainty estimates at a set of prediction points.
...
$\mathbf{k}_{\x T}=k_0(\x,X_T)=\left[k_0(\x,\x_1^T),\ldots,k_0(\x,\x_{N_T}^T)\right]$.
Similarly, $\mathbf{k}_{T\x'}=k_0(X_T,\x')$.
...
\]
We provide details of the derivation in \Cref{sec:derivation}.
...
\begin{subfigure}{0.33\textwidth}
    ...
    \caption{Top row: validation of our XFOIL-data-fit GP on a held-out test set. Bottom row: validation of our composite GP on the $7$ data points in \Cref{tab:given_data}; the squares and triangles denote the vanilla and latent GP results, respectively.}
...
\begin{figure}[p]
    ...
    \begin{subfigure}{.49\textwidth}
        ...
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa-3_flap-3_CD.png}
%        \caption{$C_d$: first moment calibrated.}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
                \caption*{Distribution-calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa-3_flap-3_CD.png}
%        \caption{$C_d$: distribution calibrated.}
    \end{subfigure}\\
    \caption*{$C_d$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa-3_flap-3_CL.png}
%        \caption{$C_l$: first moment calibrated.}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa-3_flap-3_CL.png}
%        \caption{$C_l$: distribution calibrated.}
    \end{subfigure}\\
        \caption*{$C_l$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa-3_flap-3_CM.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa-3_flap-3_CM.png}
    \end{subfigure}\\
            \caption*{$C_m$}
        \vspace{3mm}
    ...
    \end{subfigure}
    \caption{Prediction bounds at $\alpha=-3^\circ$ and $\beta_{\mathrm{flap}}=-3^\circ$. Each row shows one aerodynamic coefficient, with the first-moment-calibrated result on the left and the distribution-calibrated result on the right.}
...
\begin{figure}[p]
    ...
    \begin{subfigure}{.49\textwidth}
                \caption*{First-moment calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa0_flap0_CD.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
                \caption*{Distribution-calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa0_flap0_CD.png}
    \end{subfigure}\\
           \caption*{$C_d$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa0_flap0_CL.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa0_flap0_CL.png}
    \end{subfigure}\\
               \caption*{$C_l$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa0_flap0_CM.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa0_flap0_CM.png}
    \end{subfigure}\\
               \caption*{$C_m$}
        \vspace{3mm}
    \begin{subfigure}{1\textwidth}
    ...
    \end{subfigure}
    \caption{Prediction bounds at $\alpha=0^\circ$ and $\beta_{\mathrm{flap}}=0^\circ$. Each row shows one aerodynamic coefficient, with the first-moment-calibrated result on the left and the distribution-calibrated result on the right.}
...
\begin{figure}[p]
    ...
    \begin{subfigure}{.49\textwidth}
                \caption*{First-moment calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa2_flap2_CD.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
                \caption*{Distribution-calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa2_flap2_CD.png}
    \end{subfigure}\\
               \caption*{$C_d$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa2_flap2_CL.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa2_flap2_CL.png}
    \end{subfigure}\\
               \caption*{$C_l$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa2_flap2_CM.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa2_flap2_CM.png}
    \end{subfigure}\\
               \caption*{$C_m$}
    \vspace{3mm}
    \begin{subfigure}{1\textwidth}
    ...
    \end{subfigure}
    \caption{Prediction bounds at $\alpha=2^\circ$ and $\beta_{\mathrm{flap}}=2^\circ$. Each row shows one aerodynamic coefficient, with the first-moment-calibrated result on the left and the distribution-calibrated result on the right.}
...
\begin{figure}[p]
    ...
    \begin{subfigure}{.49\textwidth}
                \caption*{First-moment calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa7_flap15_CD.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
                \caption*{Distribution-calibrated.}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa7_flap15_CD.png}
    \end{subfigure}\\
               \caption*{$C_d$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa7_flap15_CL.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa7_flap15_CL.png}
    \end{subfigure}\\
               \caption*{$C_l$}
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/prediction_bounds/corrected_bounds_aoa7_flap15_CM.png}
    \end{subfigure}%
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/distributional_calibrated_prediction_bounds/distributional_calibrated_aoa7_flap15_CM.png}
    \end{subfigure}\\
               \caption*{$C_m$}
        \vspace{3mm}
    \begin{subfigure}{1\textwidth}
        ...
        \includegraphics[width=\linewidth]{figures/legend.png}
    \end{subfigure}
    \caption{Prediction bounds at $\alpha=7^\circ$ and $\beta_{\mathrm{flap}}=15^\circ$. Each row shows one aerodynamic coefficient, with the first-moment-calibrated result on the left and the distribution-calibrated result on the right.}
...
\begin{figure}[htb!]
    ...
    \caption{Overview of empirical CDFs for the four prediction settings and three aerodynamic coefficients. The orange curves show the first-moment-calibrated samples, the green curves show the distribution-calibrated samples, and the red vertical lines mark the provided epistemic interval edges.}
...
This work was funded by the Penn State Institute of Computational and Data Sciences (ICDS) Junior Researcher Collaboration grant. The authors also acknowledge Penn State ICDS (RRID:SCR\_025154) for providing access to computational research infrastructure within the Roar Core Facility (RRID:SCR\_026424).
